...
BadNums.new = {}
BadNums.__name__ = true
BadNums.main = function() 
  __haxe_Log.trace("Hello world!", _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="BadNums.hx",lineNumber=5,className="BadNums",methodName="main"}));
end
