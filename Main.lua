...
Main.generateRandom = function(len) 
  ...
  while (_g < _g1) do _hx_do_first_1 = false;
    ...
    _g = _g + 1;
    local v = _g - 1;
    rVec[v] = _G.math.floor((_G.math.random() * 100000) + 0.5);
  end;
  do return rVec end;
end
Main.main = function() 
  local i = 0;
  local rVec = Main.generateRandom(Main.totalLen);
  __haxe_Log.trace(rVec, _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="Main.hx",lineNumber=16,className="Main",methodName="main"}));
  while (i < (Main.totalLen - 1)) do _hx_do_first_1 = false;
  ...
  __haxe_Log.trace(rVec, _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="Main.hx",lineNumber=28,className="Main",methodName="main"}));
end
...
local _hx_static_init = function()
  ...
  String.__name__ = true;
  Array.__name__ = true;Main.totalLen = 10;
